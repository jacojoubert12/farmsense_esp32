...
float get_Soil(uint64_t reg_b){
    ...
    //float soil_moisture = (value/4095)*100;
    //float soil_moisture = map(value, 2620, 1660, 0, 100);
    float soil_moisture = map(value, 2450, 1660, 0, 100);
    if (soil_moisture < 0) { soil_moisture = 0;} // negative moisture to zero
    if (soil_moisture > 100) {soil_moisture = 100;} //no more than 100%
    //Serial.print(F("Moisture: "));
    Serial.print("Moisture ADC Value: ");
